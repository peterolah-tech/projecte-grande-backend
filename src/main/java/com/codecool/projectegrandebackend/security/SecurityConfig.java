...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/ground-transport/persist").authenticated() // allowed only when signed in
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/flight-transport/persist").authenticated() // allowed only when signed in
